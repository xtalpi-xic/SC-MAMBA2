...
class PertData:
    ...
    def get_dataloader(self, batch_size, test_batch_size = None):
        ...
        if self.split == 'no_split':
            ...
            train_sampler = DistributedSampler(cell_graphs['train'], shuffle=True)

            val_sampler = DistributedSampler(cell_graphs['val'], shuffle=True)
            ...
            val_loader = DataLoader(cell_graphs['val'], 
                                batch_size=test_batch_size, sampler = val_sampler)
