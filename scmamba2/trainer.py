...
def train(
    ...
    for batch, batch_data in enumerate(loader):
        ...
        with torch.cuda.amp.autocast(enabled=config.amp, dtype=torch.bfloat16):
            ...
            if config.CLS:
                loss_cls = nn.CrossEntropyLoss()(output_dict["cls_output"], celltype_labels)
                loss = loss + loss_cls
            ...
            if config.DAR:
                ...
                loss_dab = nn.CrossEntropyLoss()(output_dict["dab_output"], batch_labels)
...
def eval_testdata(
    ...
    if "cls" in include_types:
        ...
        with torch.no_grad(), torch.cuda.amp.autocast(enabled=config.amp, dtype=torch.bfloat16):
        ...
        adata_t.obsm["X_scmamba"] = cell_embeddings
        ...
        sc.pp.neighbors(adata_t, use_rep="X_scmamba")
